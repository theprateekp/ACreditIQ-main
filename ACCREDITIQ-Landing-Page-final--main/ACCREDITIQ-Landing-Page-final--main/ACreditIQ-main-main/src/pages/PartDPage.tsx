        ...
        <>
          ...
          <div className="card overflow-hidden">
            ...
            <div className="p-4 grid grid-cols-1 md:grid-cols-3 gap-3">
              {[
                { role: 'Principal', name: 'Dr. Rajesh Kumar', status: 'Approved' },
                { role: 'HOD', name: 'Prof. James Okafor', status: 'Approved' },
                { role: 'NBA Coordinator', name: 'Dr. Sarah Mitchell', status: 'Pending' },
              ].map((sig) => (
