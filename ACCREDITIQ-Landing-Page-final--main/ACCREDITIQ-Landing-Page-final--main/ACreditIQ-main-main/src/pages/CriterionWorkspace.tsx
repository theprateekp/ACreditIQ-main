      ...
      <div className="p-4">
        ...
        {activeTab === 'ai' && (
          <div className="flex flex-col gap-3">
            ...
            <div className="p-3 rounded" style={{ backgroundColor: 'var(--bg-row-alt)', border: '1px solid var(--border)' }}>
              <p className="text-xs font-semibold mb-1" style={{ color: 'var(--text-secondary)' }}>Why this matters for NBA:</p>
              <p className="text-xs leading-relaxed" style={{ color: 'var(--text-muted)' }}>{sub.description} NBA evaluators will look for specific evidence and quantitative data.</p>
            </div>
          </div>
        )}
      </div>
        ...
        <div className="card">
          ...
          <div className="p-3 flex flex-col gap-2">
            ...
            <textarea
              ...
              rows={3}
              style={{ backgroundColor: 'var(--bg-input)', border: '1px solid var(--border-dk)', borderRadius: 2, padding: '6px', color: 'var(--text-primary)' }}
              placeholder={`Ask about ${def.id}...`}
            />
            <button className="btn-secondary flex items-center justify-center gap-1.5 w-full">
              <SparklesIcon className="w-3 h-3" />Ask AI
            </button>
          </div>
        </div>
