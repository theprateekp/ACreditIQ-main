...
const MOCK_PART_A: Record<string, Record<string, string>> = {
  A1: {
    'Institution Name': 'National Institute of Technology — Model Campus',
    'Address': '123 Engineering Road, Tech City, State — 400001',
    'Phone': '+91-22-1234-5678',
    'Email': 'principal@nitmodel.ac.in',
    'Website': 'www.nitmodel.ac.in',
    'Year of Establishment': '1998',
    'AICTE Approval Number': 'AICTE/2024/CS/001234',
  },
  A2: {
  ...
  A4: {
    'Principal Name': 'Dr. Rajesh Kumar, Ph.D.',
    'HOD Name': 'Prof. James Okafor, Ph.D.',
    'NBA Coordinator Name': 'Dr. Sarah Mitchell, Ph.D.',
    'Contact Numbers': '+91-98765-43210',
    'Email IDs': 'nba@nitmodel.ac.in',
  },
};
